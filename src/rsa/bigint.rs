...
impl BigInt {
    ...
    pub fn modify(&mut self) {
        ...
        self.chunks[7] = self.chunks[7] | (0x8000000000000000) as u64;
...
mod tests {
    ...
    fn test_bigint_gcd(){
        ...
        first_number.chunks = [
            0xBB7AAEC868C8E485, 0x7A4827802468689A, 0xAB4DD2A321AEA8C4, 0xB360733CF4FD6600,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
        ...
        second_number.chunks = [
            0x5977A040FA3762A3, 0xD213670C9DB439D4, 0xD7D97AC1B288E91C, 0xC0774CC38AD3F465,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
            0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
        ...
        let actual = gcd(first_number, second_number);
        assert!(actual.chunks.iter().zip(expected.chunks.iter()).all(|(a,b)| a == b), "Arrays are not equal");
    }
}
